$(document).ready(function(){
    var title1 = $(".mainvisual-wrap .title-wrap > span"),
        title2 = $(".mainvisual-wrap .title-wrap > p"),
        btn = $(".main-link-btn"),
        slide = $(".mainvisual-wrap .mainvisual-slide");
    ...
    const con1 = new Swiper('.con-1-content-slider', {
        speed: 1000,
        pagination: {
            el: ".con1-pagination",
            clickable: true,
    ...
    const con3 = new Swiper('.con-3-swiper-wrapper', {
        speed: 1000,
    });
    ...
    .from(".con1-pagination ", {duration:2, y:200 ,opacity: 0,ease: Power4.easeOut}, "-=1.5")
    ...
    .to(".con2-pagination", {duration:.5, opacity: 1}, "-=.4")
    con_1_scroll.delay(2);
    ...
    .to(".con-1-img-bg.con4D", {duration:1, width:"100%", ease: Power4.easeOut}, "-=.8")
    .to(".con-1-img-img.con4D", {duration:.5, opacity: 1}, "-=.7")
